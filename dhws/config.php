...
$config = array(
    ...
    'DB_HOST'     => 'rm-wz97y25m3263o6w46o.mysql.rds.aliyuncs.com',    #数据库主机地址
//    'DB_HOST'     => 'localhost',    #数据库主机地址
	'DB_PORT'     => '3306',         #数据库端口，默认为3306
//	'DB_USER'     => 'root',         #数据库用户名
//    'DB_PWD'      => 'root',         #数据库密码
     'DB_USER'     => 'gdfangs_2017',         #数据库用户名
     'DB_PWD'      => 'Gdfangsi2017',         #数据库密码
    'DB_NAME'     => 'gdfangs_2017',    #数据库名
	...
	'HIS_URL'    => 'http://apitest.yiwubaike.com/dhapi/',       #api与HIS同步的接口
	'APPKEY'  => '20151015hz',
	'HOSPITALID' =>'1000',
	'maxRegDays' =>'7',	
